...
function StatusLabel({ status, children, muted, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: cn("status-label", muted && "is-muted", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(StatusDot, { status }),
    children ?? status
  ] });
}
...
function StatusBar({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: cn("statusbar", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "seg", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatusDot, { status: connected ? "succeeded" : "failed" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: connected ? connectedLabel : disconnectedLabel })
    ] }),
    queueDepth != null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "seg", children: [
      "queue ",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: queueDepth })
    ] }),
    services && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HealthDots, { services }),
    children,
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { flex: 1 } }),
    version && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "seg", children: version }),
    docsHref && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("a", { className: "seg", href: docsHref, children: "\u2197 docs" })
  ] });
}
function HealthDots({ services, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: cn("seg", className), children: services.map((s) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "span",
    {
      className: "tooltip-wrap",
      style: { display: "inline-flex", alignItems: "center", gap: 4 },
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatusDot, { status: s.status }),
...
function PageHead({ title, sub, className, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: cn("ace-page-head", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "lead", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h1", { children: title }),
      sub && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "sub", children: sub })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "flex items-center gap-2", children })
  ] });
}
...
function Card({ title, meta, action, flush, className, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: cn("ace-card", className), children: [
    hasHead && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "ace-card-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { children: title && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "title", children: title }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-2", children: [
        meta && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "meta", children: meta }),
        action
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: cn("ace-card-body", flush && "flush"), children })
  ] });
}
...
function Empty({ icon = "folder", title, sub, action, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: cn("empty", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "ico", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Icon, { name: icon, size: 24 }) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "ttl", children: title }),
    sub && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "sub", children: sub }),
    action && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { marginTop: 8 }, children: action })
  ] });
}
...
function Table({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "table-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("table", { className: cn("table", className), ...rest, children }) });
}
function CellStack({ className, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: cn("cell-stack", className), children });
}
function CellMeta({ name, sub, className }) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: cn("cell-meta", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "name", children: name }),
    sub && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "sub", children: sub })
  ] });
}
...
function Badge({ tone = "default", dot, className, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: cn("badge", `badge-${tone}`, dot && "badge-dot", className), children });
}
...
function Avatar({ name, src, size = "md", color, className }) {
  ...
  if (src) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: cls, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "img",
      {
        src,
        alt: name ?? "",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: cls, style: color ? { background: color, color: "#fff" } : void 0, children: initialsFor(name) });
}
function AvatarStack({ users, max = 4, className }) {
  const shown = users.slice(0, max);
  const rest = users.length - shown.length;
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: cn("avatar-stack", className), children: [
    shown.map((u, i) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Avatar, { name: u.name, size: "sm", color: u.color }, i)),
    rest > 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      "span",
      {
...
function Meter({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: cn("ace-meter", t, className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "lbl", children: label }),
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { className: "val", children: [
        format(current),
        unit && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { color: "var(--on-surface-muted)" }, children: unit }),
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { style: { color: "var(--on-surface-muted)" }, children: [
          "/ ",
          format(cap),
          unit ?? ""
        ] })
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "bar", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { width: `${pct}%` } }) })
  ] });
}
...
function LineChart({ series, w = 720, h = 240, labels, yTicks = 4 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("svg", { width: "100%", viewBox: `0 0 ${w} ${h}`, style: { display: "block" }, children: [
    ...
    labels?.map((l, i) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "text",
      {
    ...
    series.map((s, si) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("linearGradient", { id, x1: "0", x2: "0", y1: "0", y2: "1", children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("stop", { offset: "0%", stopColor: c, stopOpacity: si === 0 ? "0.18" : "0.0" }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("stop", { offset: "100%", stopColor: c, stopOpacity: "0" })
        ] }) }),
        si === 0 && fillD && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: fillD, fill: `url(#${id})` }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "path",
          {
            d,
        ...
        s.data.map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "circle",
          {
...
function BarChart({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("svg", { width: "100%", viewBox: `0 0 ${w} ${h}`, style: { display: "block" }, children: [
    ...
    data.map((v, i) => {
      ...
      const y = padT + ch - bh;
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("rect", { x, y, width: bw, height: bh, fill: color, rx: "4" }),
        labels && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "text",
          {
            x: x + bw / 2,
            y: h - 8,
...
function Donut({ segments, size = 160, thickness = 22 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("svg", { width: size, height: size, viewBox: `0 0 ${size} ${size}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "circle",
      {
        cx,
